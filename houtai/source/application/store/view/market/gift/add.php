                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">添加礼品券</div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="gift[name]"
                                           value="" placeholder="请输入礼品券名称" required>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="gift[number_prefix]"
                                           value="" placeholder="字母或数字组合，最多6位" required>
                                    <small class="x-color-red">创建后不可修改,请谨慎设置</small>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" min="10" class="tpl-form-input" name="gift[total_num]"
                                           value="1" required>
                                    <small class="x-color-red">创建后不可修改,请谨慎设置</small>
                                </div>
                            </div>
