                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">编辑局分类</div>
                            </div>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">卡片背景颜色 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="category[color]"
                                           value="<?= $model['color'] ?>" required>
                                    <small>分类卡片背景颜色，如#f00</small>
                                </div>
                            </div>
                            <div class="am-form-group">
