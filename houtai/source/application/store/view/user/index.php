                        ...
                        <form class="toolbar-form" action="">
                            ...
                            <div class="am-u-sm-12 am-u-md-3">
                                <div class="am-form-group">
                                    <?php if (checkPrivilege('user/im')): ?>
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a href="javascript:void(0);" data-id="0" class="user-im am-btn am-btn-default am-btn-success"
                                               >
                                                <span class="am-icon-plus"></span> 同步环信IM用户
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                </div>
...
<!--                                <th>实际消费金额</th>-->
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <?= $item['register_type']['text'] ?>
                                    </td>
                                    <td class="am-text-middle">
                                        <p><?= $item['is_pay'] > 0 ? '付费会员' : '免费会员' ?></p>
                                        <p><?= $item['is_pay'] > 0 ? $item['pay_start_date'] . '~' . $item['pay_end_date']: '' ?></p>
                                    </td>
...
<!--                                    <td class="am-text-middle">--><?//= $item['expend_money'] ?><!--</td>-->
                                    ...
                                    <td class="am-text-middle"><?= $item['region']['country'] .'/'. $item['region']['province'] .'/'. $item['region']['city'] ?></td>
                                        ...
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <div class="j-opSelect operation-select am-dropdown">
                                                ...
                                                <ul class="am-dropdown-content" data-id="<?= $item['user_id'] ?>">
                                                    <?php if (checkPrivilege('user/detail')): ?>
                                                    <li>
                                                        <a class="am-dropdown-item" target="_blank"
                                                           href="<?= url('user/detail', ['user_id' => $item['user_id']]) ?>">查看详情</a>
                                                    </li>
                                                    <?php endif; ?>
...
<script>
    $(function () {
        ...
        $('.user-im').delete('user_id', "<?= url('user/im') ?>", '确定同步环信IM用户？');
