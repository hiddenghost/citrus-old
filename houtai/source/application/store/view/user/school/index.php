        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget-head am-cf">
                    <div class="widget-title am-cf"> 学历认证列表</div>
                </div>
                        ...
                        <table width="100%" class="am-table am-table-compact am-table-striped
                         tpl-table-black am-text-nowrap">
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    <td class="am-text-middle"><?= $item['school_id'] ?></td>
                                    <td class="am-text-middle">
                                        <p><?= $item['user']['nickName'] ?></p>
                                    </td>
                                    <td class="am-text-middle"><?= $item['name'] ?></td>
                                    <td class="am-text-middle"><?= $item['degree'] ?></td>
                                    <td class="goods-detail am-text-middle">
                                        <div class="goods-image">
                                            <a href="<?= $item['idcard'] ?>" title="点击查看大图" target="_blank">
                                                <img src="<?= $item['idcard'] ?>" alt="">
                                            </a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('user.school/check') && $item['status'] < 1): ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if (checkPrivilege('user.school/delete')): ?>
                                                <a href="javascript:void(0);"
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?= url('user.school/delete') ?>";
        $('.item-delete').delete('school_id', url);
