...
class GameCategory extends BaseModel
{
    ...
    {
        $model = new static;
        if (!Cache::get('game_category_' . $model::$wxapp_id)) {
            ...
            Cache::tag('cache')->set('game_category_' . $model::$wxapp_id, compact('all', 'tree'));
        }
        return Cache::get('game_category_' . $model::$wxapp_id);
    }
