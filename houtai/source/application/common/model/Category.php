...
class Category extends BaseModel
{
     ...
     * @param $identifier
     */
    public static function getSubCategoryByIdentifier($identifier)
    {
        $detail = self::get(['identifier' => $identifier]);
        if(!$detail) {
            return [];
        }

        return self::where('parent_id', $detail['category_id'])->select();
    }
    ...
    {
        return self::get($category_id, ['image']);
    }
